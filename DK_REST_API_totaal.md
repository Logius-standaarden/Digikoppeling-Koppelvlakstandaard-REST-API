...
|MUST |17.5 API-15: Use PKIoverheid certificates for access-restricted or purpose-limited API authentication |  |[17.5 API-15: Use PKIoverheid certificates for access-restricted or purpose-limited API authentication](https://docs.geostandaarden.nl/api/API-Strategie-ext/#api-15-use-pkioverheid-certificates-for-access-restricted-or-purpose-limited-api-authentication) |
|WON'T |17.6 API-21: Inform users of a deprecated API actively |  |[17.6 API-21: Inform users of a deprecated API actively](https://docs.geostandaarden.nl/api/API-Strategie-ext/#api-21-inform-users-of-a-deprecated-api-actively) |
|COULD |17.7 API-22: JSON first - APIs receive and send JSON |  |[17.7 API-22: JSON first - APIs receive and send JSON](https://docs.geostandaarden.nl/api/API-Strategie-ext/#api-22-json-first-apis-receive-and-send-json) |
|COULD |17.8 API-23: APIs may provide a JSON Schema |  |[17.8 API-23: APIs may provide a JSON Schema](https://docs.geostandaarden.nl/api/API-Strategie-ext/#api-23-apis-may-provide-a-json-schema) |
