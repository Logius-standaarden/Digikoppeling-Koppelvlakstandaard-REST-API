...
De FSC standaard bestaat uit een Core component en twee extensies genaamd Logging en Delegation. Het Digikoppeling REST API profiel verplicht het gebruik van zowel Core, Logging en Delegation.
...
3. [Delegation](https://commonground.gitlab.io/standards/fsc/delegation/draft-fsc-delegation-00.html)
